...
const EditBlog = () => {
    ...
    const { data: categoryData } = useFetch(`http://localhost:3000/api/category/all-category`, {
        method: 'get',
        credentials: 'include'
    })

    const { data: blogData, loading: blogLoading } = useFetch(`http://localhost:3000/api/blog/edit/${blogid}`, {
        method: 'get',
        credentials: 'include'
    }, [blogid])
